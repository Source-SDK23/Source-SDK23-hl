...
CPropLaserRelay::CPropLaserRelay(void) {
	UseClientSideAnimation();
}


void CPropLaserRelay::Spawn(void) {
	Precache();
	SetPlaybackRate(1);
...
void CPropLaserRelay::Precache(void) {
...
bool CPropLaserRelay::Toggle(bool state, int pR, int pG, int pB) {
	if (m_bState == state) {
		return false;
	}
